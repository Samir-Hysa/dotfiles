...
vim.o.pumheight = 5 -- Pop up menu height (default: 0)
...
vim.opt.runtimepath:remove("/usr/share/vim/vimfiles") -- Separate Vim plugins from Neovim in case Vim still invim.opt.autochdir = true use (default: includes this path if Vim is installed)
